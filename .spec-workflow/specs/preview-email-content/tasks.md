...
- [x] 1. Create preview email DTOs in @project/types package
  - Files:
...
- [x] 2. Create EmailPreviewService for preview orchestration
  - Files:
...
- [x] 3. Add preview endpoint to ClaimsController
  - Files:
    - `backend/src/modules/claims/claims.controller.ts` (MODIFY - add endpoint)
  - Add GET /api/claims/:id/preview endpoint
...
- [x] 4. Register EmailPreviewService in EmailModule
  - Files:
...
- [x] 5. Create unit tests for EmailPreviewService
  - Files:
...
- [x] 6. Create integration tests for preview API endpoint
  - Files:
