...
- [ ] 1. Create CircleCI configuration with reusable commands
...
- [ ] 2. Create parameterized build-and-push job
...
- [ ] 4. Create staging-build workflow
...
- [ ] 5. Create production-build workflow
...
- [ ] 6. Validate and test CircleCI configuration
